...
enum class Colors(
    ...
    Light(
        ...
        inversePrimary = MR.colors.white.asCompose(),
        ...
        inverseSurface = MR.colors.surfaceLight.asCompose(),
        inverseOnSurface = MR.colors.onSurfaceLight.asCompose(),
        surfaceTint = MR.colors.outlineDark.asCompose(),
    ...
    Dark(
        ...
        inverseSurface = MR.colors.surfaceDark.asCompose(),
        inverseOnSurface = MR.colors.onSurfaceDark.asCompose(),
        outline = MR.colors.outlineDark.asCompose(),
        outlineVariant = MR.colors.outlineVariantDark.asCompose(),
        surfaceTint = MR.colors.black.asCompose(),
        inversePrimary = MR.colors.black.asCompose(),
